...
while 1:
    cnt += 1
    print(str(cnt).ljust(8), end="")
    f.seek(seek)

    for i in range(32):
        input32[i] = int.from_bytes(f.read(1), "little")
    ...
    if notsame:
        ...
        print("new last32")
        printline32(input32)
        outfile.write("new last32\n")
        outfile.write(printline32(input32, 0) + "\n")
    ...
    if seek == fsize:
        f.close()
        print("END FILE")
        print("samehashcounter", samehashcounter)
        print("differentlast32", differentlast32)
        exit()
